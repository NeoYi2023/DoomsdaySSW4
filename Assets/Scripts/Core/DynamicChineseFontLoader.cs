...
{
    [Header("字体配置")]
    [SerializeField] private string sourceFontPath = "Fonts/YaHei"; // Resources 路径，不含扩展名
    ...
    /// 创建动态字体资源
    /// </summary>
    private void CreateDynamicFont()
    {
        if (_dynamicFont != null)
        {
    ...
    public void SetAsDefaultFont()
    {
        ...
        TMP_Settings.defaultFontAsset = _dynamicFont;
        Debug.Log("已设置动态字体为 TextMeshPro 默认字体");
    }
